...
public class App {
   public static void main(String[] args) throws IOException {
       ...
       String bookUrl2 = "https://www.gutenberg.org/cache/epub/74776/pg74776.txt";
       ...
       input2.readFromUrl("The early court of Queen Victoria", bookUrl2);


       // Count the number of words in the original book
       int originalWordCount2 = countWords(input2);
       System.out.println("Book: The early court of Queen Victoria");
       ...
       // Save the translated book to a text file
       String fileName2 = "translated_early_court_of_Queen_Victoria.txt";
